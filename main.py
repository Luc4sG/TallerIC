...
def read_root():
    ...
    return {"description": "Esta es una pequeña API de calculadora. Puedes sumar, restar, multiplicar y dividir dos números usando las rutas /add, /subtract, /multiply y /divide."}
...
def multiply(a: float, b: float):
    ...
    return {"resultado": a * b, "mensaje": "La multiplicación se realizó correctamente."}
